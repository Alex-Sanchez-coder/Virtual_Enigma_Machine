...
### Rotors: Beta, I, III and 0 value to not include a 4 rotor   (DO NOT MODIFY ONLY IF THE SET UP IS DIFFERENT)
### Reflector: Set in B  (DO NOT MODIFY ONLY IF THE SET UP IS DIFFERENT)
### Ring settings: "23", "02", "10" and 0 value to not include a 4 rotor    (DO NOT MODIFY ONLY IF THE SET UP IS DIFFERENT)
### Starting positions: Unknown and 0 value to not include a 4 rotor    (THIS PART IS ITERATED BY THE CODE)
### Plugboard pairs: VH PT ZG BJ EY FS   (DO NOT MODIFY ONLY IF THE SET UP IS DIFFERENT)
### The code introduced was: CMFSUPKNCBMUYEQVVDYKLRQZTPUFHSWWAKTUGXMPAMYAFITXIJKMH (DO NOT MODIFY ONLY IF THE SET UP IS DIFFERENT)
### crib UNIVERSITY (DO NOT MODIFY ONLY IF THE SET UP IS DIFFERENT)
...
def decrypting(LHS_rotor, Middle_rotor1, Middle_rotor2, RHS_rotor, Reflector_list, LHS_ring_setting, Middle_ring1_setting,
            Middle_ring2_setting, RHS_ring_setting, encoded_message, crib):

    # Changing rotors initial position until get the crib in the message
    for k in range(0,26):
        for j in range(0,26):
            for i in range(0,26):

                # It begins with an A in the right hand side rotor
                LHS_position_setting = chr(k + 65)
                Middle_position1_setting = chr(j + 65)
                Middle_position2_setting = chr(i + 65)
                #print(f"LHS: {LHS_position_setting}, Middle: {Middle_position1_setting}, RHS: {Middle_position2_setting}")

                # Saving the result in a list
                encoded_message_proposal = enigma_machine_set_up(LHS_rotor, Middle_rotor1, Middle_rotor2, RHS_rotor, Reflector_list, LHS_ring_setting, Middle_ring1_setting,
                    Middle_ring2_setting, RHS_ring_setting, LHS_position_setting, Middle_position1_setting,
                    Middle_position2_setting, RHS_ring_setting, encoded_message)
                ...
                if crib in encoded_message_proposal_string:
                    ...
                    print(f"The original LHS rotor position is: {LHS_position_setting}")
                    print(f"The original Middle rotor position is: {Middle_position1_setting}")
                    print(f"The original RHS rotor position is: {Middle_position2_setting}")
...
plugboard_set_up("VH PT ZG BJ EY FS")

#Insert here the encoded message_____________(DO NOT MODIFY ONLY IF THE SET UP IS DIFFERENT)
encoded_message = "CMFSUPKNCBMUYEQVVDYKLRQZTPUFHSWWAKTUGXMPAMYAFITXIJKMH"

# Reflector_____________(DO NOT MODIFY ONLY IF THE SET UP IS DIFFERENT)
Reflector_list = "B"

#_______________________________Input Error Class_______________________________
class Checkers:
    ...
    def rotor_checker(self,string):
        self.__rotor_list=["BETA", "GAMMA", "I", "II", "III", "IV", "V", "A", "B", "C", "NEW"]
    ...
    def rotor_checker_init(self,string):
        self.__rotor_list=["BETA", "GAMMA", "I", "II", "III", "IV", "V", "NEW"]
    ...
    def reflectors_checker(self,string):
        ...
        self.__reflector_list = ["A", "B", "C", "NEW"]
